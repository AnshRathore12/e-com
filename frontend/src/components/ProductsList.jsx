        ...
        {products?.map((product)=>(
          <tr key={product._id} className='hover:bg-gray-700'>
            ...
            <td className='px-6 py-4 whitespace-nowrap '>
              ...
              className={`p-1 cursor-pointer rounded-full ${product.isFeatured? "bg-yellow-400 text-gray-900":"bg-gray-600 text-gray-300 hover:bg-gray-500 transition-colors duration-200" }`}
              >
