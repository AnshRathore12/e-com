      ...
      >
        <div className='bg-gray-800 py-8 px-4 shadow sm:rounded-lg sm:px-10'>
          <form onSubmit={handleSubmit} className='space-y-6'>
            <div>
            <label htmlFor="name" className='block text-sm font-medium text-gray-399'>
              Full Name
            </label>
            ...
            <div>
            <label htmlFor="email" className='block text-sm font-medium text-gray-399'>
              Email Address
            </label>
            <div className='mt-1 relative rounded-md shadow-sm'>
              <div className='absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none'>
            ...
            <div>
            <label htmlFor="password" className='block text-sm font-medium text-gray-399'>
              Password
            </label>
            <div className='mt-1 relative rounded-md shadow-sm'>
              <div className='absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none'>
            ...
            <div>
            <label htmlFor="confirmPassword" className='block text-sm font-medium text-gray-399'>
              Confirm Password
            </label>
            <div className='mt-1 relative rounded-md shadow-sm'>
              <div className='absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none'>
